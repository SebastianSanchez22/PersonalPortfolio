  ...
  return (
    <div name='home' className='w-full h-screen bg-[#20242b]'>
      ...
      <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
        ...
        <h1 className='animate-typing overflow-hidden whitespace-nowrap animate-text bg-gradient-to-r from-green-700 via-purple-500 to-orange-500 text-4xl sm:text-6xl font-bold bg-clip-text text-transparent'>Sebastian Sanchez</h1>
